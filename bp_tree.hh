...
namespace bp_tree
{
  ...
  struct base_node
  {
    ...
    base_node() { }
    base_node(std::streambuf* s, int key_size) { unpack(*this, key_size, s); }
  ...
  struct internal_node : base_node
  {
    ...
    internal_node() { }
    internal_node(std::streambuf* s, int key_size) { unpack(*this, key_size, s); }
  ...
  struct leaf_node : base_node
  {
    ...
    leaf_node() { }
    leaf_node(std::streambuf* s, int key_size) { unpack(*this, key_size, s); }
